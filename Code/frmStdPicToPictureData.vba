...
With Me.JGSForm.Form.Image1
    ...
    If intWidth < .Parent.Width Then
        .Width = intWidth
    Else
        MsgBox "Sorry, that is as Big as you can go!", vbOKOnly, "Do you really want to go bigger than this?"
        Exit Sub
    End If
...
With Me.JGSForm.Form.Image1
    ...
    If intWidth > 200 Then
        .Width = intWidth
    Else
        MsgBox "Sorry, that is as small as you can go!", vbOKOnly, "Do you really want to go smaller than this?"
        Exit Sub
    End If
