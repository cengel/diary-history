...
If Me.OpenArgs <> "" Then
    ...
    End If
Else
    MsgBox "No image name was passed in to this form when it was opened, system does not know which image to display. Please open from Diary form only", vbInformation, "No image to display"
End If
Exit Sub
err_open:
